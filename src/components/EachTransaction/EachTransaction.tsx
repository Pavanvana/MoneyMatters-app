...
const EachTransaction = observer((props: Props) => {
  ...
  const transactionAmountColor =
    type === "credit" ? "credit-amount-color" : "debit-amount-color";
  ...
  const [tempObj] = useState(
    new TransactionModel({ ...transactionDetails, user_id: userId })
  );
      ...
      <div className="transaction-name-container">
        ...
        {userId === "3" ? (
          ...
          <>
            <button
              type="button"
              className="edit-delete-button cursor-pointer"
                  ...
                  <div className="modal-container">
                    ...
                    <div className="transaction-input-container">
                      ...
                      <input
                        ...
                        onChange={(e) => tempObj.setName(e.target.value)}
                        value={tempObj.name}
                      />
                    </div>
                    <div className="transaction-input-container">
                      ...
                      <select
                        id="transaction-type"
                        className="transaction-input"
                        onChange={(e) => tempObj.setType(e.target.value)}
                        value={tempObj.type}
                      >
                    ...
                    <div className="transaction-input-container">
                      ...
                      <select
                        ...
                        onChange={(e) => tempObj.setCategory(e.target.value)}
                      >
                        <option disabled selected>
                          Select Category
                        </option>
                    ...
                    <div className="transaction-input-container">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          tempObj.setAmount(parseInt(e.target.value))
                        }
                      />
                    </div>
                    <div className="transaction-input-container">
                      ...
                      <input
                        ...
                        placeholder="Enter Name"
                        value={formateDate}
                        onChange={(e) => tempObj.setDate(e.target.value)}
                      />
                    </div>
        ...
        {userId === "3" ? (
          <button type="button" className="edit-delete-button cursor-pointer">
            <img
              className="edit-delete-img"
                  ...
                  <div className="logout-description-icon-con">
                    ...
                    <div>
                      ...
                      <div className="logout-btns-con">
                        <button
                          type="button"
                          className="yes-logout-btn cursor-pointer"
                        ...
                        <button
                          type="button"
                          className="cancel-logout-btn cursor-pointer"
                        >
                          No, Leave it
                        </button>
                      </div>
