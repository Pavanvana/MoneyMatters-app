    ...
    <div className="side-bar">
      <div>
        <div className="logo-container">
          ...
          <p className="app-name">
            Money <span className="matters">Matters</span>
          </p>
        </div>
          ...
          <li key="dashboard" className="dashboard-container">
            <Link to="/" className="link">
              ...
              >
                ...
                <AiFillHome
                  className={activeTab === "dashboard" ? "active-icon" : "icon"}
                />
                <p
                  className={
                    activeTab === "dashboard"
      ...
      <div className="logout-container">
        ...
        <Popup
          modal
          trigger={
            <button className="logout-buttton cursor-pointer" type="button">
                ...
                <div className="logout-description-icon-con">
                  ...
                  <div>
                    ...
                    <div className="logout-btns-con">
                      ...
                      <button type="button" className="cancel-logout-btn">
                        Cancel
                      </button>
                    </div>
                  </div>
