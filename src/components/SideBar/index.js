                ...
                {value => {
                    ...
                    return(
                        ...
                        <ul className="side-bar-components-container">
                            <li key="dashboard" className="dashboard-container" onClick={onClickDashboard}>
                            ...
                            <li key="transactions" className="dashboard-container" onClick={onClickTransactions}>
                            ...
                            <li key="profile" className="dashboard-container" onClick={onclickProfile}>
                                            ...
                                            <div className="logout-description-icon-con">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="logout-btns-con">
                                                        <button type="button" className="yes-logout-btn" onClick={this.onClickLogout}>Yes, Logout</button>
