    ...
    return (
      <>
        <div className="flex justify-between items-center pl-50px pt-10px pr-30px mb-5px">
          <p className="text-#343C6A font-sans text-18px roman font-bold mr-32">
            Transaction Name
          </p>
          <p className="text-#343C6A font-sans text-18px roman font-bold ml-16">
            Category
          </p>
          <p className="text-#343C6A font-sans text-18px roman font-bold ml-16 mr-10">
            Date
          </p>
          <p className="text-#343C6A font-sans text-18px roman font-bold ml-10 mr-40">
            Amount
          </p>
        </div>
    ...
    <div className="flex flex-row">
      ...
      <div>
        <div className="flex flex-row w-1100px pl-30px pt-24px justify-between items-center bg-white fixed">
          <h1 className="text-#343C6A text-24px roman font-bold leading-normal pl-6 font-sans">
            Transactions
          </h1>
          <AddTransaction />
        </div>
        <ul className="flex flex-row list-reset ml-2">
          {transactionsTypes.map((eachType) => (
            <TabItem
              key={eachType.id}
              setActiveTabId={changeActiveTabId}
