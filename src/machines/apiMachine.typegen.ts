...
export interface Typegen0 {
  "@@xstate/typegen": true;
  internalEvents: {
    "done.invoke.apiMachine.loading:invocation[0]": {
      type: "done.invoke.apiMachine.loading:invocation[0]";
      data: unknown;
      __tip: "See the XState TS docs to learn how to strongly type this.";
    };
    "error.platform.apiMachine.loading:invocation[0]": {
      type: "error.platform.apiMachine.loading:invocation[0]";
      data: unknown;
    };
